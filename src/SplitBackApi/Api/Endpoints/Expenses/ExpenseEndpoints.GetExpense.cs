...
public static partial class ExpenseEndpoints
{
    ...
    IUserRepository userRepository)
  {
    ...
    var expenseResult = await expenseRepository.GetById(expenseId);
    ...
    var usersResult = await userRepository.GetByIds(userMembers.Select(u => u.UserId).ToList());
    if (usersResult.IsFailure) return Results.BadRequest(usersResult.Error);
